 ...
 * </p>
 * <ul>
 *   <li>{@link polybot_modelling_language.impl.MoveStraightImpl#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MoveStraightImpl extends InstructionImpl implements MoveStraight {
	/**
	...
	protected EClass eStaticClass() {
		return Polybot_modelling_languagePackage.Literals.MOVE_STRAIGHT;
	}
	...
	public void setDistance(int newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Polybot_modelling_languagePackage.MOVE_STRAIGHT__DISTANCE, oldDistance, distance));
	}
